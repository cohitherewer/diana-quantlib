...
class CustomDataset(Dataset):
    def __init__(self, annotations_file,  transform=None, target_transform=None,img_base_dir = "" ):# annotation file contains absolute paths 
...
class ImagenetTrainDataset(CustomDataset): 
    def __init__(self) : 
        pre_processing_training_transform = transforms.Compose([transforms.RandomResizedCrop(224),
               ...
               transforms.ToTensor(),
                normalize]) 
        super().__init__(train_annotation_file , pre_processing_training_transform, img_base_dir=imagenet_train_path)
class ImagenetValidationDataset(CustomDataset): 
    def __init__(self) : 
        pre_processing_validation_transform = transforms.Compose([transforms.Resize(256),
                ...
                transforms.ToTensor(),
                normalize]) 
        super().__init__(val_annotation_file , pre_processing_validation_transform , img_base_dir=imagenet_val_path)