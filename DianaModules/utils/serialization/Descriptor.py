...
class ModuleDescriptor(YAMLObject):  
    ...
    def __init__(self , name :str , core_choice :   CoreDescriptor, qhinitparam: str = 'meanstd', qgranularityspec: Union[str , None] = None, weight_size = None) -> None:
    ...
    def __repr__(self):
        return "%s(name=%r, core_choice=%r, qhinitparam=%r, qgranularityspec=%r, kernel_size=%r)" % (self.__class__.__name__, self.name, self.core_choice, self.qhinitparam, self.qgranularityspec, self.kernel_size) 
    def get_dict(self) : 
