...
#                               Fake Quantization                              #
# ---------------------------------------------------------------------------- #
module_descriptions_pth = "/imec/other/csainfra/nada64/DianaTraining/serialized_models/resnet8.yaml"
...
model.set_quantized()
model.load_state_dict(torch.load("zoo/cifar10/resnet8/resnet8_fq_mixed-epoch=13-val_acc=0.9247.ckpt", map_location="cpu")["state_dict"])
#torch.save ({
...
model.load_state_dict(torch.load("zoo/cifar10/resnet8/resnet8_hw_mixed-epoch=73-val_acc=0.9017.ckpt", map_location="cpu")["state_dict"])
