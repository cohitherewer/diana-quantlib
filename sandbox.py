...
def measure_performance (func , benchmark_loop_count, *args, **kwargs) : # returns 
    # dry runs 
    times = []
    for i in range(5) : 
...
print("memory usage: " , b - a) 
mean , std = measure_performance(nn.functional.conv2d , 100 , feature_map , kernel , None , stride , padding )
...
mean , std = measure_performance(conv_method ,100 , feature_map=feature_map , kernel=kernel ,stride=stride , padding=padding)
