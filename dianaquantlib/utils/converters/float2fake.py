...
from dianaquantlib.utils.grapheditors.fake_quantization.ActFuser import (
    DianaQuantizerFuser,
    DianaBranchFuser,
)
from dianaquantlib.utils.grapheditors.fake_quantization.AnalogConv import (
    AnalogConvMapper,
)
from dianaquantlib.utils.grapheditors.fake_quantization.Interposer import (
    DianaF2FInterposer,
)
...
from quantlib.editing.editing.float2fake.canonicalisation import (
    F2FCanonicaliser,
)

from quantlib.editing.editing.float2fake.quantisation.addtreeharmoniser.retracer import (
    QuantLibHarmonisedAddRetracer,
)
from quantlib.editing.editing.float2fake.quantisation.addtreeharmoniser.rewriter import (
    AddTreeHarmoniser,
)

from quantlib.editing.editing.float2fake.quantisation.modulewiseconverter.modulewisedescription.modulewisedescription import (
    ModuleWiseDescriptionSpecType,
)

from quantlib.editing.editing.float2fake.quantisation.modulewiseconverter.rewriter import (
    ModuleWiseConverter,
)
from quantlib.editing.editing.float2fake.quantisation.qdescription.qdescription import (
    QDescriptionSpecType,
)
...
class F2FQuantiser(ComposedEditor):
    ...
    def __init__(
        ...
        if map_to_analog:
            editors.append(
                AnalogConvMapper(
                    analogcoredescriptionspec, modules_descriptors
                )
            )
        editors += [
